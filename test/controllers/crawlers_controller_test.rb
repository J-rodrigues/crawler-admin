...
class CrawlersControllerTest < ActionController::TestCase
  ...
  test "should create crawler" do
    assert_difference('Crawler.count') do
      post :create, crawler: { css_box: @crawler.css_box, css_nome: @crawler.css_nome, css_preco: @crawler.css_preco, css_url: @crawler.css_url, loja_id: @crawler.loja_id, site_url: @crawler.site_url }
    end
  ...
  test "should update crawler" do
    patch :update, id: @crawler, crawler: { css_box: @crawler.css_box, css_nome: @crawler.css_nome, css_preco: @crawler.css_preco, css_url: @crawler.css_url, loja_id: @crawler.loja_id, site_url: @crawler.site_url }
    assert_redirected_to crawler_path(assigns(:crawler))
  end
